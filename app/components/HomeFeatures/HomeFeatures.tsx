...
import { APP_GITHUB_URL, APP_NAME } from '@/app/constants';
...
const mockdata = [
  {
    ...
    description: (
      <>
        Rest easy knowing your newsletter system's API keys are never stored and all requests are
        encrypted. Still skeptical?{' '}
